...
<div data-role="header" data-icon-left="home">
	<a href="pagina1.php" class="ui-btn ui-corner-all ui-shadow ui-icon-home ui-btn-icon-notext">princiapal</a>
  <h1>Calendario</h1>
  <a href="#" class="ui-btn ui-corner-all ui-shadow ui-icon-bullets ui-btn-icon-notext">opciones</a>
</div>
