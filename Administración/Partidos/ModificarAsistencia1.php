...
$resultado1=mysql_fetch_array($consulta1);
  ...
  $consulta2=mysql_query("SELECT * FROM tb_jugadores WHERE equipo=$idequipo1 ORDER BY nombre1 asc");
  $i=0;
  while($consultajugadores = mysql_fetch_array($consulta2)){

$idjugador=$consultajugadores['id_jugadores'];
$consulta3= mysql_query("SELECT * from tr_jugadoresxpartido where partido=$partido and jugador=$idjugador ");
	?>
