...
<?php
$partidos = mysql_query("SELECT * from tb_partidos WHERE Estado!='2'");
  while ($res_partidos=mysql_fetch_array($partidos)) {
...
$nombrelugar= mysql_query("SELECT * from tb_lugares WHERE id_lugar='$idlugar'");
$equi1=mysql_query("SELECT * from tb_equipos WHERE id_equipo='$equipo1'");
$equi2=mysql_query("SELECT * from tb_equipos WHERE id_equipo='$equipo2'");
...
while($res1= mysql_fetch_array($equi1)){
  
while($res2= mysql_fetch_array($equi2)){
