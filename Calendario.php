...
<?php 
$numerodelafecha=mysql_query("SELECT  DISTINCT numero_fecha FROM tb_partidos WHERE Estado='1' ");
...
<?php
$nametor = mysql_query("SELECT * from tb_partidos where  Estado!='2'  AND numero_fecha=$numeroparalafecha  ORDER BY fecha asc, hora asc")or die(mysql_error());
