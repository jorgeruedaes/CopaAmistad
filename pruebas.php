...
<div data-role="page" id="pagina1">    <!-- PAGINA PRINCIPAL 1 -->
  ...
  <a style="text-decoration: initial;color: white;font-weight: 400;font-size:smaller;" 
   href="Noticias.php" data-icon="info-white"  data-transition="Flip"><img src="images/icons-png/info-white.png" style="margin-right: 10%;">Noticias
   <img src="images/icons-png/carat-r-white.png" style="margin-left: 50%;"></a>
<br>
<br>
<a style="text-decoration: initial;color: white;font-weight: 400; font-size:smaller;" href="Amonestaciones.php" 
style="text-decoration: initial;color: white;font-weight: 400;" data-icon="alert-white" data-transition="Flip">
<img src="images/icons-png/info-white.png" style="margin-right: 10%;">Amonestaciones <img src="images/icons-png/carat-r-white.png" style="margin-left: 26%;"></a>
...
<br>
  <br>
    ...
    <a style="text-decoration: initial;color: white;font-weight: 400;font-size:smaller;" 
     ...
     <img src="images/icons-png/info-white.png" style="margin-right: 10%;">
     Sugerencias<img src="images/icons-png/carat-r-white.png" style="margin-left: 37%;"></a>
    <br><br>
    <a style="text-decoration: initial;color: white;font-weight: 400;font-size:smaller;"
      href="Acercade.php" data-icon="info"  data-transition="Flip"><img src="images/icons-png/info-white.png" style="margin-right: 10%;">
      Acerca De<img src="images/icons-png/carat-r-white.png" style="margin-left: 40%;"></a>
    </p>
  </div>
...
$primerafecha=date("Ymd")-7;
$ultimafecha=date("Ymd")+7;


$numerodelafecha=mysql_query("SELECT  DISTINCT fecha FROM tb_partidos WHERE Estado='1' AND fecha BETWEEN '$primerafecha' AND '$ultimafecha'  ORDER BY fecha asc");
...
<ul data-role="listview" data-inset="true">
  ...
  $primerafecha=date("Ymd")-7;
$ultimafecha=date("Ymd")+7;
      /// INICIO RESULTADOS POR EQUIPOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
// consulta los partidos de la fecha
$nametor = mysql_query("SELECT * FROM tb_partidos where  Estado='2' AND fecha BETWEEN '$primerafecha' AND '$ultimafecha'   ORDER BY fecha asc")or die(mysql_error());
  while ($tor=mysql_fetch_array($nametor)) {
     ?>
  <div align="center" data-role="list-divider" style="color: grey;height: 30px;margin-top: 3px;padding-top: 5px;
      " ><?php
...
<?php  /// fin de resultados por EQUIPOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
