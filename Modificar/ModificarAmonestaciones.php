...
if (mysql_num_rows($consulta) > 0)
  {
   ...
   echo" </select>\n";
     ...
     ?>
<div class="submit"><input type="submit" value="Buscar" name="buscar"/></div></form><script type="text/javascript" src="formoid15_files/formoid1/formoid-flat-black.js"></script>
